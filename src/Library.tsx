    ...
    content: (
      <article>
        ...
        <div className="grid gap-4 mt-6">
          {/* IT Recruitment */}
          <div className="p-6 rounded-xl bg-gradient-to-br from-blue-500/[0.08] to-blue-500/[0.02] border border-blue-500/[0.15]">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-blue-500/20 flex items-center justify-center">
                <Users size={20} className="text-blue-400" />
              </div>
              <div>
                <h4 className="m-0 text-[16px] text-white/90">IT Recruitment</h4>
                <p className="m-0 text-[12px] text-white/40">Tech companies hiring → IT recruiters</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-blue-400/70 mb-2">Demand</div>
                <p className="m-0 text-[13px] text-white/70">Tech companies with open roles. They need help hiring.</p>
              </div>
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-emerald-400/70 mb-2">Supply</div>
                <p className="m-0 text-[13px] text-white/70">IT recruiters and staffing agencies. They find candidates.</p>
              </div>
            </div>
          ...
          {/* Biotech */}
          <div className="p-6 rounded-xl bg-gradient-to-br from-purple-500/[0.08] to-purple-500/[0.02] border border-purple-500/[0.15]">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-purple-500/20 flex items-center justify-center">
                <Zap size={20} className="text-purple-400" />
              </div>
              <div>
                <h4 className="m-0 text-[16px] text-white/90">Biotech</h4>
                <p className="m-0 text-[12px] text-white/40">Biotech companies → Pharma BD partners</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-purple-400/70 mb-2">Demand</div>
                <p className="m-0 text-[13px] text-white/70">Biotech companies with assets. They need partners.</p>
              </div>
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-emerald-400/70 mb-2">Supply</div>
                <p className="m-0 text-[13px] text-white/70">Big pharma BD teams. They in-license assets.</p>
              </div>
            </div>
            <div className="mt-4 p-3 rounded-lg bg-white/[0.02] border border-white/[0.04]">
              <div className="text-[10px] uppercase tracking-wider text-white/30 mb-2">Example presignal</div>
          ...
          {/* Wealth Management */}
          <div className="p-6 rounded-xl bg-gradient-to-br from-amber-500/[0.08] to-amber-500/[0.02] border border-amber-500/[0.15]">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-amber-500/20 flex items-center justify-center">
                <DollarSign size={20} className="text-amber-400" />
              </div>
              <div>
                <h4 className="m-0 text-[16px] text-white/90">Wealth Management</h4>
                <p className="m-0 text-[12px] text-white/40">HNW individuals → Wealth managers</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-amber-400/70 mb-2">Demand</div>
                <p className="m-0 text-[13px] text-white/70">High net worth people. They need wealth advice.</p>
              </div>
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-emerald-400/70 mb-2">Supply</div>
                <p className="m-0 text-[13px] text-white/70">Wealth advisors and family offices. They manage money.</p>
              </div>
            </div>
            <div className="mt-4 p-3 rounded-lg bg-white/[0.02] border border-white/[0.04]">
              <div className="text-[10px] uppercase tracking-wider text-white/30 mb-2">Example presignal</div>
          ...
          {/* Real Estate */}
          <div className="p-6 rounded-xl bg-gradient-to-br from-cyan-500/[0.08] to-cyan-500/[0.02] border border-cyan-500/[0.15]">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-cyan-500/20 flex items-center justify-center">
                <Layers size={20} className="text-cyan-400" />
              </div>
              <div>
                <h4 className="m-0 text-[16px] text-white/90">Real Estate</h4>
                <p className="m-0 text-[12px] text-white/40">RE projects → Capital partners and investors</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-cyan-400/70 mb-2">Demand</div>
                <p className="m-0 text-[13px] text-white/70">Developers with projects. They need capital.</p>
              </div>
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-emerald-400/70 mb-2">Supply</div>
                <p className="m-0 text-[13px] text-white/70">Capital partners and investors. They deploy money.</p>
              </div>
            </div>
            <div className="mt-4 p-3 rounded-lg bg-white/[0.02] border border-white/[0.04]">
              <div className="text-[10px] uppercase tracking-wider text-white/30 mb-2">Example presignal</div>
          ...
          {/* B2B (Broad) */}
          <div className="p-6 rounded-xl bg-gradient-to-br from-fuchsia-500/[0.08] to-fuchsia-500/[0.02] border border-fuchsia-500/[0.15]">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-fuchsia-500/20 flex items-center justify-center">
                <GitBranch size={20} className="text-fuchsia-400" />
              </div>
              <div>
                <h4 className="m-0 text-[16px] text-white/90">B2B (Broad)</h4>
                <p className="m-0 text-[12px] text-white/40">General B2B intros across industries</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-fuchsia-400/70 mb-2">Demand</div>
                <p className="m-0 text-[13px] text-white/70">Companies with any B2B need. Broad industries.</p>
              </div>
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-emerald-400/70 mb-2">Supply</div>
                <p className="m-0 text-[13px] text-white/70">B2B partners and vendors. Must have senior titles.</p>
              </div>
            </div>
            <div className="mt-4 p-3 rounded-lg bg-white/[0.02] border border-white/[0.04]">
              <div className="text-[10px] uppercase tracking-wider text-white/30 mb-2">Example presignal</div>
          ...
          {/* Crypto */}
          <div className="p-6 rounded-xl bg-gradient-to-br from-orange-500/[0.08] to-orange-500/[0.02] border border-orange-500/[0.15]">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-orange-500/20 flex items-center justify-center">
                <Zap size={20} className="text-orange-400" />
              </div>
              <div>
                <h4 className="m-0 text-[16px] text-white/90">Crypto</h4>
                <p className="m-0 text-[12px] text-white/40">Web3 companies and protocols</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-orange-400/70 mb-2">Demand</div>
                <p className="m-0 text-[13px] text-white/70">Crypto-native companies. Web3 protocols. Blockchain.</p>
              </div>
              <div className="p-3 rounded-lg bg-white/[0.03]">
                <div className="text-[10px] uppercase tracking-wider text-emerald-400/70 mb-2">Supply</div>
                <p className="m-0 text-[13px] text-white/70">Crypto partners and investors. Web3 ecosystem players.</p>
              </div>
            </div>
            <div className="mt-4 p-3 rounded-lg bg-white/[0.02] border border-white/[0.04]">
              <div className="text-[10px] uppercase tracking-wider text-white/30 mb-2">Example presignal</div>
          ...
          {/* Custom */}
          <div className="p-6 rounded-xl bg-gradient-to-br from-white/[0.04] to-white/[0.01] border border-white/[0.08]">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center">
                <Sparkles size={20} className="text-white/60" />
              </div>
              <div>
                <h4 className="m-0 text-[16px] text-white/90">Custom</h4>
                <p className="m-0 text-[12px] text-white/40">You define both sides</p>
              </div>
            </div>
            <p className="m-0 text-[13px] text-white/50">
              For niches not listed above. No auto-filtering. You must choose correct datasets.
            </p>
            <div className="mt-3 p-2 rounded-lg bg-amber-500/[0.06] border border-amber-500/[0.1]">
              <p className="m-0 text-[10px] text-amber-400/70">Requires acknowledgement. Claims blocked without evidence.</p>
            </div>
          </div>
        </div>
        ...
        <p>
          Each mode has words you can use and words you cannot use. This prevents mistakes.
        </p>

        <div className="p-5 rounded-xl bg-gradient-to-br from-red-500/[0.06] to-transparent border border-red-500/[0.12] mt-4">
          <div className="text-[11px] uppercase tracking-wider text-red-400/70 mb-3">Example: Biotech mode</div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="text-[10px] text-emerald-400/70 mb-2">Allowed</div>
              <p className="m-0 text-[12px] text-white/50">licensing, partnership, pipeline, asset, clinical, phase</p>
            </div>
            <div>
              <div className="text-[10px] text-red-400/70 mb-2">Forbidden</div>
              <p className="m-0 text-[12px] text-white/50">hiring, recruiting, staffing, candidates, role, position</p>
            </div>
          </div>
          <p className="m-0 mt-3 text-[11px] text-white/30">
            If you say "hiring" in biotech mode, the system blocks it. Wrong lane.
          </p>
        </div>

        <h3>Evidence rules</h3>
        <p>
          You cannot claim something without proof. The system checks.
        </p>

        <div className="p-5 rounded-xl bg-gradient-to-br from-amber-500/[0.06] to-transparent border border-amber-500/[0.12] mt-4">
          <div className="text-[11px] uppercase tracking-wider text-amber-400/70 mb-3">Examples</div>
          <ul className="m-0 text-[13px] text-white/60 space-y-2">
            <li>Say "hiring" → Need job posting proof</li>
            <li>Say "raised Series B" → Need funding proof</li>
            <li>Say "uses React" → Need tech stack proof</li>
          </ul>
          <p className="m-0 mt-3 text-[11px] text-white/30">
            No proof? The system won't let you say it. This keeps you honest.
          </p>
        </div>

        <h3>How to pick a mode</h3>
        <p>
          Ask yourself: "Who pays me when a deal closes?"
        </p>
        <ul>
          <li>IT recruiters pay you? → <strong>IT Recruitment</strong></li>
          <li>Pharma BD pays you? → <strong>Biotech</strong></li>
          <li>Wealth managers pay you? → <strong>Wealth Management</strong></li>
          <li>RE investors pay you? → <strong>Real Estate</strong></li>
          <li>Any B2B vendor/partner pays you? → <strong>B2B (Broad)</strong></li>
          <li>Crypto/Web3 players pay you? → <strong>Crypto</strong></li>
          <li>Something else? → <strong>Custom</strong> (requires acknowledgement)</li>
        </ul>

        <div className="p-5 rounded-xl bg-gradient-to-br from-white/[0.03] to-transparent border border-white/[0.06] mt-6">
          <p className="text-[14px] text-white/60 italic m-0 text-center">
            "Pick the mode. The system handles the rest."
          </p>
        </div>
      </article>
    ),
